...
import os
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "crollingProject.settings")
import django
django.setup()
from app.models import mlonList

# 자동화가 막힌 페이지에 접근할 때 적어줘야함
# 구글에 'User Agent 확인'이라고 치면 컴퓨터마다 확인 가능 (위에 뜨는 것 복붙)
